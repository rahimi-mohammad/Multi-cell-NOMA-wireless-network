...
legend('BS1 NE','BS1 RANDOM'...
    ,'BS2 NE','BS2 RANDOM');
saveas(gcf,['rateG for ', num2str(N_i),' IRS elements-N1= ', num2str(N1),'-N2=',num2str(N2),'.jpg'])
%% plot 2 Utility
figure
tiledlayout(1,2)
nexttile
...
% draw results
    ...
    legend('BS1 NE','BS1 RANDOM'...
        ,'BS2 NE','BS2 RANDOM');
    saveas(gcf,['utilityG for ', num2str(N_i),' IRS elements-N1= ', num2str(N1),'-N2=',num2str(N2),'.jpg'])
%     