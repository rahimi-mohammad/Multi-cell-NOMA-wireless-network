...
for i = 1:SV
    ...
    EPG_final_rate( :, i) = rate(s1_star,s2_star,:,i);
    EPG_final_utility( :, i) = EPG_utility(s1_star,s2_star,:,i);
end
toc
%% plot 1 SumRate
% figure
...
plot(start:step:(SV-1)*step+start,Random_final_utility(1,1:i),'b',...
    ...
    'MarkerFaceColor','b',...
    'linewidth',1)
plot(start:step:(SV-1)*step+start,EPG_final_utility(2,1:i),'r-*',...
            'linewidth',1)
