...
function [utility, rate]=game(M_t, M_r, N1, N2, N_i, P_T, x, y, z, x1, y1, z1,...
   ...
   for j=1:N_iter
        ...
        rate=rate/N_iter;
        utilityG(1, 1, 1)=rateG(1, 1, 1);
        utilityG(1, 1, 2)=rateG(1, 1, 2);
        utilityG(1, 2, 1)=rateG(1, 2, 1);    
        utilityG(2, 1, 2)=rateG(2, 1, 2);

        utilityG(1, 2, 2)=rateG(1, 2, 2)-r*N_i;
        utilityG(2, 1, 1)=rateG(2, 1, 1)-r*N_i;

        utilityG(2, 2, 1)=utilityG(2, 1, 1)-r*N_i/2;
        utilityG(2, 2, 2)=utilityG(1, 2, 2)-r*N_i/2;        
end
